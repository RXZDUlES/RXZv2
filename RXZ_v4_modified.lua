-- ============================================================
-- RXZ SCRIPT - WITH STAND DROP (Crasher) & JUMP DROP
...
if introShouldPlay then
    ...
    loadingBar.BackgroundColor3 = Color3.fromRGB(220,220,220)
...
local Steal = { AutoStealEnabled=true, StealRadius=63, StealDuration=0.25, Data={} }
...
-- ============================================================
local C = {
    winBg=Color3.fromRGB(0,0,0), winBg2=Color3.fromRGB(6,6,6), winBorder=Color3.fromRGB(60,60,60),
    sidebarBg=Color3.fromRGB(0,0,0), sidebarDiv=Color3.fromRGB(30,30,30),
    topBg=Color3.fromRGB(6,6,6), topTitle=Color3.fromRGB(230,230,230), topSub=Color3.fromRGB(150,150,150),
    topBtn=Color3.fromRGB(70,70,70), topBtnHov=Color3.fromRGB(100,100,100), topDivider=Color3.fromRGB(30,30,30),
    tabBarBg=Color3.fromRGB(0,0,0), tabBarDiv=Color3.fromRGB(30,30,30),
    tabIdle=Color3.fromRGB(105,105,105), tabIdleHov=Color3.fromRGB(200,200,200),
    tabActive=Color3.fromRGB(230,245,235), tabActiveBg=Color3.fromRGB(16,16,16), tabUnderline=Color3.fromRGB(60,60,60),
    sectionTxt=Color3.fromRGB(120,120,120), sectionDiv=Color3.fromRGB(30,30,30),
    rowBg=Color3.fromRGB(0,0,0), rowBorder=Color3.fromRGB(28,28,28), rowLabel=Color3.fromRGB(225,225,225),
    rowSub=Color3.fromRGB(140,140,140), rowValue=Color3.fromRGB(200,200,200), rowHov=Color3.fromRGB(16,16,16),
    inputBg=Color3.fromRGB(12,12,12), inputBorder=Color3.fromRGB(50,50,50), inputFocus=Color3.fromRGB(120,120,120),
    inputTxt=Color3.fromRGB(230,230,230),
    pillOff=Color3.fromRGB(18,18,18), pillOn=Color3.fromRGB(60,60,60), dotOff=Color3.fromRGB(58,58,58),
    dotOn=Color3.fromRGB(10,10,10), pillBorder=Color3.fromRGB(50,50,50),
    modeBtnBg=Color3.fromRGB(12,12,12), modeBtnBrd=Color3.fromRGB(45,45,45), modeBtnTxt=Color3.fromRGB(210,210,210),
    modeBtnActBg=Color3.fromRGB(60,60,60), modeBtnActTx=Color3.fromRGB(0,0,0),
    chipBg=Color3.fromRGB(12,12,12), chipBorder=Color3.fromRGB(45,45,45), chipTxt=Color3.fromRGB(170,170,170),
    btnBg=Color3.fromRGB(12,12,12), btnBorder=Color3.fromRGB(50,50,50), btnTxt=Color3.fromRGB(210,210,210),
    btnHov=Color3.fromRGB(16,16,16),
    stackBg=Color3.fromRGB(8,8,8), stackBrd=Color3.fromRGB(38,38,38), stackTxt=Color3.fromRGB(210,210,210),
    stackActBg=Color3.fromRGB(40,40,40), stackActBrd=Color3.fromRGB(60,60,60), stackActTxt=Color3.fromRGB(230,230,230),
    stackDot=Color3.fromRGB(50,50,50), stackDotOn=Color3.fromRGB(130,130,130),
    infoBg=Color3.fromRGB(8,8,8), infoBrd=Color3.fromRGB(38,38,38), infoTxt=Color3.fromRGB(150,150,150),
    infoVal=Color3.fromRGB(170,170,170), infoFill=Color3.fromRGB(60,60,60),
    accent=Color3.fromRGB(60,60,60), accentDim=Color3.fromRGB(45,45,45),
    presetBg=Color3.fromRGB(12,12,12), presetBrd=Color3.fromRGB(45,45,45), presetLoad=Color3.fromRGB(60,60,60),
    presetDel=Color3.fromRGB(80,25,25), delBrd=Color3.fromRGB(130,45,45), lockOn=Color3.fromRGB(60,60,60),
...
do
    ...
    for _,name in ipairs(cleanupNames) do
        ...
        pcall(function() local o=LP.PlayerGui:FindFirstChild(name); if o then o:Destroy() end end)
    end
end
...
local function Main()
    ...
    bgImg.BackgroundColor3 = Color3.fromRGB(12,12,12); bgImg.BorderSizePixel = 0; bgImg.ZIndex = 0
    mkCorner(bgImg, 24)
    ...
    mainStroke.Thickness = 1.4; mainStroke.Color = Color3.fromRGB(60,60,60); mainStroke.Transparency = 0.2
    ...
    accentBar.BackgroundColor3 = Color3.fromRGB(60,60,60); accentBar.BackgroundTransparency = 0.85
    ...
    avatarBg.BackgroundColor3 = Color3.fromRGB(12,12,12); avatarBg.BorderSizePixel = 0; avatarBg.ZIndex = 6
    mkCorner(avatarBg,16); mkStroke(avatarBg, Color3.fromRGB(60,60,60), 1.5).Transparency = 0.25
    ...
    titleLbl.BackgroundTransparency = 1; titleLbl.Text = "RXZ"
    ...
    subTitleLbl.BackgroundTransparency = 1; subTitleLbl.Text = "RXZ Script"
    ...
    local TABS = {"Speed", "Combat", "Auto Steal", "Movement", "Visual"}
    local tabPages = {}
    ...
    local function makeInputRow(label, default, onChange)
        ...
        row.Size = UDim2.new(1,-16,0,42); row.BackgroundColor3 = Color3.fromRGB(18,18,18)
        row.BorderSizePixel=0; row.LayoutOrder=LO(); mkCorner(row,12)
        local rowStroke = mkStroke(row, Color3.fromRGB(50,50,50),1); rowStroke.Transparency = 0.5
        row.MouseEnter:Connect(function()
            TweenService:Create(row,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(24,24,24)}):Play()
            TweenService:Create(rowStroke,TweenInfo.new(0.1),{Transparency=0.2}):Play()
        end)
        row.MouseLeave:Connect(function()
            TweenService:Create(row,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(18,18,18)}):Play()
        ...
        boxWrap.BackgroundColor3 = Color3.fromRGB(8,8,8); boxWrap.BorderSizePixel=0
        mkCorner(boxWrap,8); local bs = mkStroke(boxWrap, Color3.fromRGB(50,50,50),1); bs.Transparency=0.3
        ...
        box.Focused:Connect(function() TweenService:Create(bs,TweenInfo.new(0.15),{Color=Color3.fromRGB(60,60,60),Transparency=0}):Play() end)
        box.FocusLost:Connect(function()
            TweenService:Create(bs,TweenInfo.new(0.15),{Color=Color3.fromRGB(50,50,50),Transparency=0.3}):Play()
            if onChange then
    ...
    local function makeToggleRow(label, defaultOn, onToggle)
        ...
        pillBg.BackgroundColor3 = defaultOn and Color3.fromRGB(60,60,60) or Color3.fromRGB(30,36,32)
        ...
        local function setV(on)
            ...
            TweenService:Create(pillBg, TweenInfo.new(0.18, Enum.EasingStyle.Quint), {
                BackgroundColor3 = on and Color3.fromRGB(60,60,60) or Color3.fromRGB(30,36,32)
            }):Play()
    ...
    local function makeKeybindRow(label, currentKey, onChanged, keyName)
        ...
        kbtn.MouseButton1Click:Connect(function()
            ...
            TweenService:Create(kbtn,TweenInfo.new(0.12),{BackgroundColor3=Color3.fromRGB(0,120,220)}):Play()
            TweenService:Create(ks,TweenInfo.new(0.12),{Color=Color3.fromRGB(0,120,220)}):Play()
    ...
    do
        local page = buildPage("Speed", function()
            ...
            laggerCarryBox = makeInputRow("Lagger Carry Speed", State.laggerCarrySpeed, function(n) if n>0 and n<=500 then State.laggerCarrySpeed=n end end)        end)
        page.LayoutOrder = 1
    end
    ...
    do
        local page = buildPage("Combat", function()
            ...
            toggleSetters["medusaCounter"] = setMedusaCounter        end)
        page.LayoutOrder = 2
    end
    ...
    do
        local page = buildPage("Movement", function()
            ...
            dropTypeRow.BackgroundColor3 = Color3.fromRGB(18,18,18)
            dropTypeRow.BorderSizePixel = 0
            dropTypeRow.LayoutOrder = LO()
            mkCorner(dropTypeRow, 12)
            local dropTypeStroke = mkStroke(dropTypeRow, Color3.fromRGB(50,50,50), 1)
            ...
            standDropBtn.TextColor3 = (currentDropType == DROP_TYPES.STAND) and Color3.fromRGB(0,0,0) or C.inputTxt
            ...
            jumpDropBtn.TextColor3 = (currentDropType == DROP_TYPES.JUMP) and Color3.fromRGB(0,0,0) or C.inputTxt
            ...
            standDropBtn.MouseButton1Click:Connect(function()
                ...
                standDropBtn.TextColor3 = Color3.fromRGB(0,0,0)
            ...
            jumpDropBtn.MouseButton1Click:Connect(function()
                ...
                jumpDropBtn.TextColor3 = Color3.fromRGB(0,0,0)
    ...
    do
        local page = buildPage("Visual", function()
            ...
            do
                local fovRow = Instance.new("Frame", currentPage); fovRow.Size = UDim2.new(1,-16,0,42); fovRow.BackgroundColor3=Color3.fromRGB(18,18,18); fovRow.BorderSizePixel=0; fovRow.LayoutOrder=LO(); mkCorner(fovRow,12)
                local fovStroke = mkStroke(fovRow, Color3.fromRGB(50,50,50),1); fovStroke.Transparency=0.5
    ...
    do
        local page = buildPage("Settings", function()
            makeGap(2); makeSectionHeader("Interface"); makeGap(2)            uiScaleBox = makeInputRow("UI Scale", 1.0, function(n) if n>=0.5 and n<=2.0 then if uiScaleObj then uiScaleObj.Scale=n end end end)
            ...
            saveBtn.MouseEnter:Connect(function() TweenService:Create(saveBtn,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(120,120,120)}):Play() end)
            ...
            saveBtn.MouseButton1Click:Connect(function()
                ...
                if success then saveBtn.Text="✓  Saved!"; saveBtn.BackgroundColor3=Color3.fromRGB(46,46,46) else saveBtn.Text="✗  Save Failed"; saveBtn.BackgroundColor3=Color3.fromRGB(180,60,60) end
            ...
            resetAllBtn.MouseButton1Click:Connect(function()
                ...
                Steal.StealRadius=63; Steal.StealDuration=0.25; Steal.AutoStealEnabled=true
                ...
                resetAllBtn.Text="✓  All Settings Reset!"; resetAllBtn.BackgroundColor3=Color3.fromRGB(120,120,120)
            ...
            _G._VezyFlashSave = function(success)
                ...
                if success then lbl.Text="✓  Auto-saved"; lbl.TextColor3=Color3.fromRGB(150,150,150)
                else lbl.Text="✗  Save failed"; lbl.TextColor3=Color3.fromRGB(220,80,80) end
                task.delay(1.5,function() if lbl and lbl.Parent then             end
        end)
        page.LayoutOrder = 6
    end
    ...
    rebuildPresetList = function()
        ...
        for i,preset in ipairs(Presets) do
            ...
            loadBtn.MouseEnter:Connect(function() TweenService:Create(loadBtn,TweenInfo.new(0.1),{BackgroundColor3=Color3.fromRGB(0,100,220)}):Play() end)
    ...
    infoBar.BackgroundColor3 = Color3.fromRGB(10,10,10); infoBar.BorderSizePixel=0; infoBar.Active=true
    mkCorner(infoBar,18); mkStroke(infoBar, Color3.fromRGB(150,150,150), 1.5)

    local progressBg = Instance.new("Frame", infoBar)
    progressBg.Size = UDim2.new(1,-8,1,-8); progressBg.Position = UDim2.new(0,4,0,4)
    ...
    progressFill.Size = UDim2.new(0,0,1,0); progressFill.BackgroundColor3 = Color3.fromRGB(150,150,150)
    ...
    stealTextLbl.BackgroundTransparency=1; stealTextLbl.Text="STEAL"; stealTextLbl.TextColor3=Color3.fromRGB(190,190,190)
    ...
    stealPctLbl.BackgroundTransparency=1; stealPctLbl.Text="0%"; stealPctLbl.TextColor3=Color3.fromRGB(150,150,150)
    ...
    startBatAimbot = function()
        ...
        Conns.aimbot = RunService.RenderStepped:Connect(function()
            ...
            local predictPos=targetPos+targetVel*0.14; predictPos=predictPos+target.CFrame.LookVector*1.3
    ...
    local function startRagTimerGui()
        ...
        task.spawn(function()
            ...
            local lbl = getRagTimerLbl()
            if lbl then lbl.Text = "STEAL!"; lbl.TextColor3 = Color3.fromRGB(200, 200, 200) end
    ...
    local function setupChar(char)
        ...
        if head then
            ...
            local speedBillLbl=Instance.new("TextLabel",bb); speedBillLbl.Name="SpeedBillLbl"; speedBillLbl.Size=UDim2.new(1,0,0,24); speedBillLbl.BackgroundTransparency=1; speedBillLbl.Text="0.0"; speedBillLbl.TextColor3=Color3.fromRGB(220,220,220); speedBillLbl.Font=Enum.Font.GothamBlack; speedBillLbl.TextScaled=true; speedBillLbl.TextStrokeTransparency=0.1; speedBillLbl.TextStrokeColor3=Color3.new(0,0,0); speedBillLbl.LayoutOrder=1
            local discordLbl=Instance.new("TextLabel",bb); discordLbl.Size=UDim2.new(1,0,0,22); discordLbl.BackgroundTransparency=1; discordLbl.Text="discord.gg/rxz"; discordLbl.TextColor3=Color3.fromRGB(220,220,220); discordLbl.Font=Enum.Font.GothamBold; discordLbl.TextScaled=true; discordLbl.TextStrokeTransparency=0.1; discordLbl.TextStrokeColor3=Color3.new(0,0,0); discordLbl.LayoutOrder=2
    ...
    cloverBtn.Size = UDim2.new(0,220,0,36)
    cloverBtn.Position = UDim2.new(0,20,0,200)
    cloverBtn.BackgroundColor3 = Color3.fromRGB(18,18,18)
    cloverBtn.BorderSizePixel = 0
    cloverBtn.Text = "discord.gg/rxz"
    cloverBtn.TextColor3 = Color3.fromRGB(220,220,220)
    cloverBtn.Font = Enum.Font.GothamBold
    cloverBtn.TextSize = 14
    cloverBtn.ZIndex = 25
    cloverBtn.Visible = true
    mkCorner(cloverBtn,12)
    mkStroke(cloverBtn, Color3.fromRGB(60,60,60), 1.5)
    ...
    cloverBtn.MouseEnter:Connect(function() TweenService:Create(cloverBtn, TweenInfo.new(0.12), {BackgroundColor3=Color3.fromRGB(25,25,25)}):Play() end)
    cloverBtn.MouseLeave:Connect(function() TweenService:Create(cloverBtn, TweenInfo.new(0.12), {BackgroundColor3=Color3.fromRGB(18,18,18)}):Play() end)
...
local _reset_remote   = nil
local _reset_cooldown = false
local _auto_reset_on  = true

pcall(function()
    local _orig_fire
    _orig_fire = hookfunction(Instance.new("RemoteEvent").FireServer, newcclosure(function(self, ...)
        if not _reset_remote and type(self.Name) == "string" and self.Name:sub(1,3) == "RE/" then
            _reset_remote = self
        end
...
local function instaReset()
    if _reset_cooldown then return end
    if not _reset_remote then return end
    _reset_cooldown = true
    local oldChar = LP.Character
    task.spawn(function()
        while LP.Character == oldChar do
            pcall(function() _reset_remote:FireServer(_reset_GUID, LP, "balloon") end)
            task.wait()
        end
        _reset_cooldown = false
    end)
end

local _RS = game:GetService("ReplicatedStorage")
local function _connectResetRemote(obj)
    obj.OnClientEvent:Connect(function(...)
        if not _auto_reset_on then return end
...
for _, obj in ipairs(_RS:GetDescendants()) do
    if obj:IsA("RemoteEvent") then _connectResetRemote(obj) end
end
_RS.DescendantAdded:Connect(function(obj)
    if obj:IsA("RemoteEvent") then _connectResetRemote(obj) end
end)
...
local function setupOtherPlayerSpeed(player)
    ...
    local function onCharacterAdded(char)
        ...
        speedLbl.Text = "0.0"
        speedLbl.TextColor3 = Color3.fromRGB(20, 20, 20)
